...
<div id="roleUpd">
    <form class="layui-form" action="" style="margin:40px;">
        <input type="hidden" id="upd_role_id" name="roleId" value="${roleId}">
        <div class="layui-form-item">
            <label class="layui-form-label">角色名称</label>
            <div class="layui-input-block">
                <input type="text" id="upd_role_name" name="roleName" value="${roleName}" required lay-verify="name"
        ...
        <div class="layui-form-item" style="margin-left: 160px">
            <div class="layui-input-block">
                <button type="submit" id="submit" style="display: none" class="layui-btn" lay-submit lay-filter="UpdRoles">立即提交</button>
