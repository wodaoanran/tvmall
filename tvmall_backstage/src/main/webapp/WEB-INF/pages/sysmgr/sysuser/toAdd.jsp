...
<div id="roleAdd">
    <form class="layui-form" action="" style="margin:40px;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input id="passOne" type="password" name="loginPwd" required
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="userName" required lay-verify="name"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="checkbox" name="status"  value="1" lay-skin="switch" lay-text="正常|禁用" checked />
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">超级管理员</label>
            <div class="layui-input-block">
                <input type="checkbox" name="identity" value="1" lay-skin="switch" lay-text="&nbsp;&nbsp;是&nbsp;&nbsp;|&nbsp;&nbsp;否&nbsp;&nbsp;" />
            </div>
        </div>
      <%--  <div class="layui-form-item">
        ...
        <div class="layui-form-item" style="margin-left: 160px">
            <div class="layui-input-block">
                <button type="submit" id="submit" style="display: none" class="layui-btn" lay-submit lay-filter="AddSysUser">立即提交</button>
