layui.define(['jquery','grid'], function (exports) {
	var $ = layui.jquery;
    var Grid = layui.grid;
    var TreeGrid = {
        config: Grid.config,
        createNew: function (option) {
            ...
            grid.dataSuccess = function (pageData) {
                ...
                var treeRows = [];
                HELPER.treeData(pageData.rows, treeRows, grid.root); // modified by yss@20180803
    ...
    layui.link(layui.cache.base + 'layui/css/modules/grid.css', null, 'gridcss');
});
